...
- [x] **状态管理完善**
  - [x] 策略 Store（Pinia），避免重复 API 请求
  - [x] 行情 Store，缓存 Ticker 数据
  - [x] 订单 Store，实时更新订单状态

- [x] **UX 优化**
  - [x] 全局 Loading 骨架屏
  - [x] 操作确认弹窗（删除策略、撤单、切换实盘）
  - [x] 表单持久化（浏览器关闭后恢复未提交内容）
  - [x] 快捷键支持
  - [x] 深色模式
  - [x] 专业术语提示（TermTip 组件 + 术语词典 + 新手引导帮助面板）
